...
using SeminarskaNalogaIvan.Data;
...
namespace SeminarskaNalogaIvan.Controllers
{
    ...
    {
        private SeminarskaNalogaIvanContext db = new SeminarskaNalogaIvanContext();
        ...
        public ActionResult Create([Bind(Include = "StudentiId,StudentiName,Age")] Studenti studenti)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentiId,StudentiName,Age")] Studenti studenti)
        {
            if (ModelState.IsValid)
            {
