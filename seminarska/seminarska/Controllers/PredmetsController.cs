...
namespace seminarska.Controllers
{
    public class PredmetsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PredmetId,PredmetIme")] Predmet predmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PredmetId,PredmetIme")] Predmet predmet)
        {
            if (ModelState.IsValid)
            {
